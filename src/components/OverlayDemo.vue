        ...
        <div class="col-12 lg:col-6">
            ...
            <div class="card">
                ...
                <Sidebar v-model:visible="visibleLeft" :baseZIndex="1000">
                    ...
                    <Button type="button" @click="visibleLeft = false" label="Save" class="p-button-success" style="margin-right: 0.25em" />
                ...
                <Sidebar v-model:visible="visibleRight" :baseZIndex="1000" position="right">
                    ...
                    <Button type="button" @click="visibleRight = false" label="Save" class="p-button-success" style="margin-right: 0.25em" />
                ...
                <Sidebar v-model:visible="visibleTop" :baseZIndex="1000" position="top">
                    ...
                    <Button type="button" @click="visibleTop = false" label="Save" class="p-button-success" style="margin-right: 0.25em" />
                ...
                <Sidebar v-model:visible="visibleBottom" :baseZIndex="1000" position="bottom">
                    ...
                    <Button type="button" @click="visibleBottom = false" label="Save" class="p-button-success" style="margin-right: 0.25em" />
                ...
                <Sidebar v-model:visible="visibleFull" :baseZIndex="1000" position="full">
                    ...
                    <Button type="button" @click="visibleFull = false" label="Save" class="p-button-success" style="margin-right: 0.25em" />
