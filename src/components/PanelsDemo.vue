                ...
                <div class="grid">
                    ...
                    <div class="col-5 align-items-center justify-content-center">
                        ...
                        <p class="line-height-3 m-0">
                            ...
                            consequatur aut perferendis doloribus asperiores repellat. Donec vel volutpat ipsum. Integer nunc magna, posuere ut tincidunt eget,
                    ...
                    <Splitter style="height: 300px" class="mb-5">
                        <SplitterPanel :size="40" :minSize="10" style="overflow: scroll">
                            <p class="col m-3">
                                ...
                                distinctio obcaecati quibusdam repellat, est assumenda quam perferendis reprehenderit, blanditiis, excepturi facilis!
                                Voluptatem.
                            </p>
                        </SplitterPanel>
